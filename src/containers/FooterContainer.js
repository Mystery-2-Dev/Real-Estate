  ...
  return (
    <Footer>
      <Footer.Container>
        <Footer.Content>
          <Footer.Item>
            <Footer.Title>90acres</Footer.Title>
            <Footer.Text>         
              Malviya Nagar,Delhi,Uttar Pradesh
            </Footer.Text>
            <Footer.List>
              <Footer.ListItem>
                <Footer.Icon name="fas fa-phone-alt" social="true" />
                <Footer.Text>5699038389</Footer.Text>
              </Footer.ListItem>
              <Footer.ListItem>
              ...
              <Footer.ListItem>
                ...
                <Footer.Text>90acres@gmail.com</Footer.Text>
              </Footer.ListItem>
            </Footer.List>
          </Footer.Item>
          <Footer.Item>
      ...
      <Footer.Bottom>
        <Footer.Container>
          <Footer.Text>&copy; 90acres. All Rights Reserved</Footer.Text>
        </Footer.Container>
      </Footer.Bottom>
    </Footer>
  );
